...
\begin{itemize}
    \item \definitie{\textbf{Resource ownership} (Bezit van bronnen)} : Aan een proces wordt een virtuele adresruimte toegewezen voor de opslag van het procesbeeld.
    \item \definitie{\textbf{Scheduling / execution} (Inroosteren en uitvoering)}: Een proces is een uitvoeringspad door een of meer programma’s en kan verweven worden met die van andere processen.
\end{itemize}
